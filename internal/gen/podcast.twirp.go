...
func (c *podProtobufClient) UpsertSubscription(ctx context.Context, in *Subscription) (*Response, error) {
	ctx = ctxsetters.WithPackageName(ctx, "protos")
	ctx = ctxsetters.WithServiceName(ctx, "Pod")
	ctx = ctxsetters.WithMethodName(ctx, "UpsertSubscription")
	caller := c.callUpsertSubscription
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *Subscription) (*Response, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*Subscription)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*Subscription) when calling interceptor")
					}
					return c.callUpsertSubscription(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Response)
...
func (c *podProtobufClient) callUpsertSubscription(ctx context.Context, in *Subscription) (*Response, error) {
	out := new(Response)
...
func (c *podJSONClient) UpsertSubscription(ctx context.Context, in *Subscription) (*Response, error) {
	ctx = ctxsetters.WithPackageName(ctx, "protos")
	ctx = ctxsetters.WithServiceName(ctx, "Pod")
	ctx = ctxsetters.WithMethodName(ctx, "UpsertSubscription")
	caller := c.callUpsertSubscription
...
func (c *podJSONClient) callUpsertSubscription(ctx context.Context, in *Subscription) (*Response, error) {
	out := new(Response)
...
func (s *podServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "UpsertSubscription":
		s.serveUpsertSubscription(ctx, resp, req)
		return
...
func (s *podServer) serveUpsertSubscription(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveUpsertSubscriptionJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveUpsertSubscriptionProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *podServer) serveUpsertSubscriptionJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "UpsertSubscription")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.Pod.UpsertSubscription
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *Subscription) (*Response, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*Subscription)
					if !ok {
					...
					return s.Pod.UpsertSubscription(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Response)
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Response and nil error while calling UpsertSubscription. nil responses are not supported"))
		return
	}
...
func (s *podServer) serveUpsertSubscriptionProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "UpsertSubscription")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
var twirpFileDescriptor2 = []byte{
	...
	,
}
